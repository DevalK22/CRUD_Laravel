        ...
        <div class="d-block justify-content-center align-items-center" style="margin-top:50px; margin-left: 400px;">
            <div class="col-md-8">
                <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                    <h2 class="text-center">CRUD - Create Read Update Delete</h2>
                    ...
                    <form action="{{ route('employee_post') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="department" id="departmentInput" placeholder="Enter your department">
                            @error('department')
                                <span class="d-block fs-6 text-danger mt-2">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="designation" id="designationInput" placeholder="Enter your designation">
                            @error('designation')
                                <span class="d-block fs-6 text-danger mt-2">{{ $message }}</span>
                            @enderror
                        </div>
